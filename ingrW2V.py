# -*- coding: utf-8 -*-
# import word2vec_food as word2vec
...
def trainW2V():
    ...
    sentences = word2vec.LineSentence('data/ingredients_titles.txt')
    ...
    model = word2vec.Word2Vec(sentences, size=300, min_count=20, window=5, sg=1)
